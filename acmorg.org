...
# ACM SIGPLAN template adapted from Lucas Mello Schnorr's ACM Small template.
# https://github.com/schnorr/acmorg
# Code in "Local Variables" at the bottom must be executed for this to work.

#+TITLE: Title (appears only in the PDF properties)
# Title for decorative purposes; defined down in *The Paper*>Frontpage>Title
...
# Custom export class defined at the end of this file
#+LATEX_CLASS: ACMART
# Default ACMART SIGPLAN options
